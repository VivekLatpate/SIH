...
export default function HomePage() {
  const [currentPage, setCurrentPage] = useState<'home' | 'digital-ids' | 'verify-id'>('home')
  ...
  ], [handleDigitalIDClick, handleVerifyIDClick])
            ...
            <Sidebar 
              ...
              solutions={solutions.map(({ id, title, icon }: Solution) => ({ 
                ...
                onClick: id === 'digital-ids' ? handleDigitalIDClick : 
                         id === 'verify-id' ? handleVerifyIDClick : undefined
              }))} 
